...
export var conf = {
    comments: {
        lineComment: ";",
        blockComment: ['#comments-start', '#comments-end']
    },
    brackets: [
        ['{', '}'],
        ['[', ']'],
...
export var language = {
    ...
    tokenizer: {
        root: [
            ...
            [/\d*\.\d+(e[\-+]?\d+)?(@floatsuffix)/, 'number.float'],
            [/0x[0-9a-f]+(@integersuffix)/, 'number.hex'],
            ...
            [/[{}()\[\]]/, '@brackets'],
            [/@symbols/, 'delimiter'],
            [/^\s*#\s*[\w-]+/, 'keyword.directive.include'],
            // strings
        ...
        whitespace: [
            [/[ \t\r\n]+/, ''],
            [/;.*$/, 'comment'],            
            [/#comments-start/, 'comment', '@comment']
        ],
        comment: [
            [/#comments-end/, 'comment', '@pop'],
